...
router.put('/:questionId/done', auth_1.authMiddleware, Questions_1.markQuestionAsDone);
router.get('/:questionId/next', auth_1.authMiddleware, Questions_1.getNextQuestions);
